...
class HackChat:
    def __init__(self, channel: str, nick: str, color: str=""):
        self.onlineUsers = []
        self.channel = channel
        self.nick = nick
        self.ws = websocket.create_connection("wss://cmd.melon.fish/hcbbs")
        self._sendPacket({"cmd": "join", "channel": channel, "nick": nick})
        if color:
